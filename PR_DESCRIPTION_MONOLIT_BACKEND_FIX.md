...
```
monolit-planner-api.onrender.com/api/otskp/search?q=420324
...
```bash
curl "https://monolit-planner-api.onrender.com/api/otskp/search?q=420324"
```
**Expected:**
```json
{
...
```bash
curl -X DELETE "https://monolit-planner-api.onrender.com/api/monolith-projects/by-project-name/NonExistent"
```
**Expected:**
```json
{
