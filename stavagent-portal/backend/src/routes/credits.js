/**
 * Credits Routes — User-facing + Admin
 *
 ...
 *
 * Notes:
 *   Self-service topup (Stripe checkout + webhook) was removed 2026-05-08.
 *   Stripe was never commercially activated; paid plans launch in Q3 2026
 *   via Lemon Squeezy (Merchant of Record). Until then, credit accounting
 *   is read-only for users + admin-only writes via /admin/topup.
 */
