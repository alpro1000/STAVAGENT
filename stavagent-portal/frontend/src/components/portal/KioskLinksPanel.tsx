...
const KIOSK_META: Record<string, { label: string; icon: string; color: string; url: string }> = {
  ...
  registry: { label: 'Klasifikátor stavebních prací', icon: '\u{1F4CA}', color: '#f59e0b', url: 'https://stavagent-backend-ktwx.vercel.app' },
  urs_matcher: { label: 'Klasifikátor URS', icon: '\u{1F50E}', color: '#22c55e', url: 'https://urs-matcher-service-1086027517695.europe-west3.run.app' },
};
