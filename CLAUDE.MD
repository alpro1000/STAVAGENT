...
После развёртывания:
- Backend получит URL: `https://monolit-planner-api.onrender.com`
- Frontend получит URL: `https://monolit-planner-frontend.onrender.com`
- В Render Dashboard → frontend → Environment → добавить `VITE_API_URL=https://monolit-planner-api.onrender.com`
...
**Симптом:** `monolit-planner-api.onrender.com/api/positions:1 Failed to load resource: the server responded with a status of 500`
