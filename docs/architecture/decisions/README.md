...
| [ADR-009](ADR-009_document_to_worklist_spine_and_uwo_canon.md) | Document→worklist 6-stage spine, UWO as deterministic Bind layer, canonical UWO carrier + supersedes-ledger | Proposed | 2026-07-12 |
