...
| `test-data/tz/SO-250_golden_test.md` ⭐ | operne_zdi (zárubní zeď), rimsa | **Hlavní říms test** — 525 bm říms, 42 dilatačních celků, C30/37 XF4+XD3+XC4, pohledové C2d bednění |
