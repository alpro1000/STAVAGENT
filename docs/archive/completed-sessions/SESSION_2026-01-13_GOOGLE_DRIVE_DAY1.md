...
### Test 1: Health Check
```bash
curl https://concrete-agent-3uxelthc4q-ey.a.run.app/api/v1/google/health
...
1. Open in browser:
   ```
   https://concrete-agent-3uxelthc4q-ey.a.run.app/api/v1/google/auth?user_id=test_user_123
   ```
...
```bash
curl https://concrete-agent-3uxelthc4q-ey.a.run.app/api/v1/google/folders?user_id=test_user_123
