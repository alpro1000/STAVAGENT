...
**Otevřené otázky:** Gate 3 = HK212 coverage harness (CI-side, PŘED retrofitem) → nálezy = v1.3 data-fix → Gate 4 retrofit `vocabulary_code` → Gate 5 split §9.1.

**Co dál:** Gate 3 na pokyn.
