...
**Otevřené otázky:** Gate 5 split `create_work_breakdown` (SPEC §9.1 BLOCKING — poslední blokátor; po něm se řetěz stádií 1–4 poprvé uzavře: Stage-1 «žádný kód, žádná cena» server-enforced).

**Co dál:** Gate 5 (GO od Alexandra už dán v sekvenci «po zeleném Gate 4»).
