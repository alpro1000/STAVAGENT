...
**Error:**
```
Access to fetch at 'https://concrete-agent.onrender.com/api/v1/passport/generate' 
...
# 3. Test CORS headers
curl -I https://concrete-agent.onrender.com/health \
...
curl -X OPTIONS https://concrete-agent.onrender.com/api/v1/passport/generate \
  -H "Origin: https://www.stavagent.cz" \
