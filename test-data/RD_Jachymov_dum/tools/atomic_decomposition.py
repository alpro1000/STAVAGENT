...
DECOMP: dict[tuple[str, str], list[dict]] = {
    ...
    ("260219_dum.HSV1.005", "HSV-1 Zemní práce"): [
        {"suffix": "a", "popis": "Osazení rektifikovatelných terčů výšky ~50 mm na betonové dlaždice — terasa za opěrnou stěnou (nesou dřevěnou pochozí vrstvu PSV76.002)", "mj": "m²", "qty": 30.0, "urs": "", "status": "needs_lookup", "qty_formula": "= HSV1.005 plocha terasy 30 m²", "pozn": "Rektifikovatelné terče — spec systém (família needs_lookup). Nesou dřevěný rošt + prkna (PSV76.002 Truhlář, 762)."},
