...
| betonáž (24 os. = 12/linku × 2 čerpadla, 693.35 m³ / 35 m³/h = 19.8 h, rotace > 12 h) | 1.6 | 380.4 | 475.5 | 0.55 | crew-model |
...
plochy (ne půdorysné!) · betonáž crew-model (čета 12 = 4 ukládka + 3 vibrace
+ 2 finiš + 3 čerpadlo/koordinace na linku × 2 linky; tandem efektivně
30–40 m³/h, projekce střed 35; rotace čet při > 12 h zůstává vzvedená —
headcount na stavbě konstantní, Nh se nedubluje). Norm-based větve mají
