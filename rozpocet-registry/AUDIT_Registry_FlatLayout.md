...
*Подсекция 2.5 (Как Planner решает проблему множества действий в строке), разделы 3 (Conflicts), 4 (Proposals), 5 (Recommendation) будут добавлены в следующих коммитах.*
