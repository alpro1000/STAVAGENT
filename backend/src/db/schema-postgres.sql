...
INSERT INTO part_templates (template_id, object_type, part_name, display_order, is_default, description) VALUES
  ('bridge_ZÁKLADY', 'bridge', 'ZÁKLADY', 1, TRUE, 'Hloubkové založení pro opěry'),
  ('bridge_OPĚRY', 'bridge', 'OPĚRY', 2, TRUE, 'Krajní opěry (pilíře koncové)'),
  ('bridge_PILÍŘE', 'bridge', 'PILÍŘE', 3, TRUE, 'Mezilehlé nosné pilíře'),
  ('bridge_KLENBY', 'bridge', 'KLENBY', 4, TRUE, 'Rozpětí mostu (pole)'),
  ('bridge_ŘÍMSY', 'bridge', 'ŘÍMSY', 5, TRUE, 'Okrajové prvky a ochranné prvky'),
  ('building_ZÁKLADY', 'building', 'ZÁKLADY', 1, TRUE, 'Hloubkové a plošné základy'),
  ('building_SLOUPY', 'building', 'SLOUPY', 2, TRUE, 'Nosné sloupy a pilíře'),
  ('building_STĚNY', 'building', 'STĚNY', 3, TRUE, 'Nosné a nenosné stěny'),
  ('building_STROPY', 'building', 'STROPY', 4, TRUE, 'Stropní konstrukce'),
  ...
  ('parking_STĚNY', 'parking', 'STĚNY', 3, TRUE, 'Bočné nosné stěny'),
  ('parking_STROPY', 'parking', 'STROPY', 4, TRUE, 'Stropní platformy'),
  ('parking_RAMPY', 'parking', 'RAMPY', 5, TRUE, 'Sjezdové rampy a komunikace'),
  ('road_ZÁKLADY', 'road', 'ZÁKLADY', 1, TRUE, 'Zemní těleso'),
  ('road_PODBASE', 'road', 'PODBASE', 2, TRUE, 'Podkladní vrstva'),
