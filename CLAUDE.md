...
Node.js/Express + React. **132 endpoints**, **1249 shared tests**, **~43K LOC**.
Structure: `shared/` (1249 tests, ~30 files), `backend/` (Jest tests — env-isolated, not run via vitest workspace), `frontend/` (0 tests). Design: Slate Minimal (`--r0-*`).
