# peri_cb_240_cb_160_climbing_formwork
...
- **Slug:** `peri_cb_240_cb_160_climbing_formwork`
- **Bucket:** `B5_tech_cards`
- **GCS path:** `gs://stavagent-cenik-norms/B5_tech_cards/peri_cb_240_cb_160_climbing_formwork/`
- **Vertex AI data store:** `urs-otskp-csn-norms-cenik` (region europe-west3)
- **Title (cs):** PERI CB 240 a CB 160 — šplhavé bednění
- **Title (en):** PERI CB 240 & CB 160 — crane-climbed formwork
- **Vendor:** PERI
- **Product:** CB 240 / CB 160
- **Doc type:** `tech_card`
- **Language:** cs
- **Files in folder (1):**
  - `source_prospekt.pdf`
...
2. `git grep peri_cb_240_cb_160_climbing_formwork` finds the document, and
3. PR reviewers can see KB additions without reading the bucket.

## Fetching the source

```bash
gsutil cp gs://stavagent-cenik-norms/B5_tech_cards/peri_cb_240_cb_160_climbing_formwork/source_prospekt.pdf .
```
