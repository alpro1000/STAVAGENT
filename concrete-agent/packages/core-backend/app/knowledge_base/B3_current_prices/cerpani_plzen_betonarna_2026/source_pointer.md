...
- **Slug:** `cerpani_plzen_betonarna_2026`
- **Bucket:** `B3_current_prices`
- **GCS path:** `gs://stavagent-cenik-norms/B3_current_prices/cerpani_plzen_betonarna_2026/`
- **Vertex AI data store:** `urs-otskp-csn-norms-cenik` (region europe-west3)
- **Title (cs):** Ceník čerpání — betonárna Plzeň 2026
- **Title (en):** Concrete pumping price list — Plzeň plant 2026
- **Vendor:** betonárna Plzeň
- **Valid from:** 2026
- **Doc type:** `price_list`
- **Language:** cs
- **Files in folder (1):**
...
2. `git grep cerpani_plzen_betonarna_2026` finds the document, and
3. PR reviewers can see KB additions without reading the bucket.

## Fetching the source

```bash
gsutil cp gs://stavagent-cenik-norms/B3_current_prices/cerpani_plzen_betonarna_2026/source.pdf .
```
