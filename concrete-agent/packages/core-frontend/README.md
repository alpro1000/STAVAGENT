...
`https://concrete-agent-3uxelthc4q-ey.a.run.app` (configurable via environment variables) and renders chat
...
| -------------- | ------------------------------------------------- | ------------------------------------- |
| `VITE_API_URL` | Base URL of the backend FastAPI service (HTTPS).  | `https://concrete-agent-3uxelthc4q-ey.a.run.app` |
