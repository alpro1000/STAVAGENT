...
export type StructuralElementType = 'zaklady_piliru' | 'driky_piliru' | 'rimsa' | 'operne_zdi' | 'mostovkova_deska' | 'rigel' | 'opery_ulozne_prahy' | 'kridla_opery' | 'mostni_zavirne_zidky' | 'prechodova_deska' | 'podkladni_beton' | 'podlozkovy_blok' | 'zakladova_deska' | 'zakladovy_pas' | 'zakladova_patka' | 'stropni_deska' | 'stena' | 'sloup' | 'pruvlak' | 'schodiste' | 'nadrz' | 'podzemni_stena' | 'pilota' | 'other';
