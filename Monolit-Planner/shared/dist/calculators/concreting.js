 ...
 */
export function calculateConcreting(params) {
    // Validate inputs
 ...
 */
export function calculateRequiredPumpCapacity(volume_m3, max_continuous_hours, setup_hours, washout_hours) {
 ...
 */
export function calculateOptimalCaptures(total_volume_m3, q_eff_m3_h, max_continuous_hours, setup_hours, washout_hours) {
 ...
 */
export function calculatePumpUtilization(total_pour_hours, project_duration_days, shift_hours) {
