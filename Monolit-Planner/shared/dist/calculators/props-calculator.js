 ...
 */
export function selectPropSystem(height_m, override_name, preferred_manufacturer) {
    if (override_name) {
    ...
    if (preferred_manufacturer) {
        const matching = candidates.filter(s => s.manufacturer.toLowerCase() === preferred_manufacturer.toLowerCase());
