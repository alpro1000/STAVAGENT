 ...
 */
export function findActiveTariff(registry, supplier_id, service, date = today()) {
 ...
 */
export function getRate(tariff, key) {
 ...
 */
export function getTariffHistory(registry, supplier_id, service) {
 ...
 */
export function getSuppliersByService(registry, service, date = today()) {
    const seen = new Set();
    const result = [];
 ...
 */
export function comparePrices(registry, supplier_id, service, date = today()) {
 ...
 */
export function adjustForInflation(tariff, target_index) {
 ...
 */
export function createRegistry(base_year) {
