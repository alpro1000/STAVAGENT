 ...
 * });
 */
export function calculateFormwork(params) {
    // Validate inputs
    if (params.area_m2 <= 0)
 ...
 */
export function calculateCadenceB(assembly_days, disassembly_days, rebar_days, concrete_days, curing_days) {
 ...
 */
export function calculateStrategies(cycle_days, curing_days, work_days, num_captures, transport_days = 1) {
 ...
 */
export function calculateMaxConcurrentCaptures(kit_occupancy_days, total_captures, kits_count) {
    return Math.min(kits_count, total_captures);
}
/**
 * Calculate formwork kit utilization
 */
export function calculateKitUtilization(kit_occupancy_days, project_duration_days, kits_count) {
 ...
 */
export function calculateFullCycleRentalDays(assembly_days, rebar_days, concrete_days, curing_days, stripping_days, move_clean_days, rebar_overlap_days = 0) {
 ...
 */
export function calculateThreePhaseFormwork(area_m2, norm_assembly_h_m2, norm_disassembly_h_m2, crew_size, shift_h, k, wage_czk_h, num_captures) {
