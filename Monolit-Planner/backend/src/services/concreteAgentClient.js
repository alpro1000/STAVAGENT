 ...
 * Wrapper for calling the CORE Engine at https://concrete-agent-3uxelthc4q-ey.a.run.app
 *
...
// Configuration
const CONCRETE_AGENT_URL = process.env.CONCRETE_AGENT_URL || 'https://concrete-agent-3uxelthc4q-ey.a.run.app';
