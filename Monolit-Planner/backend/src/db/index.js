...
if (USE_POSTGRES) {
  ...
  try {
    ...
    console.error('[Database] Hint: Check DATABASE_URL in Secret Manager.');
    console.error('[Database] Expected: postgresql://user:pass@/dbname?host=/cloudsql/project:region:instance');
